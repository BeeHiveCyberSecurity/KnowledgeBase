...
The [ASUS Chromebook Flip](https://www.asus.com/us/Notebooks/ASUS\_Chromebook\_Flip\_C100PA/) is a quad core 1.8GHz, with 2GB or 4GB of RAM Chromebook with a 10.1" 10 point mult-touch touchscreen. Kali Linux fits on an external microSD card or USB drive.

By default, the Kali Linux ASUS Chromebook Flip image contains the [**kali-linux-default** metapackage](https://www.kali.org/docs/general-use/metapackages/) similar to most other platforms. If you wish to install extra tools please refer to our [metapackages page](https://www.kali.org/docs/general-use/metapackages/).
...
[Kali on ASUS Chromebook Flip - Build-Script Instructions](broken-reference)
...
[Kali on ASUS Chromebook Flip - User Instructions](broken-reference)
...
```
$ xzcat kali-linux-2022.4-chromebook-veyron-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```
...
[Kali on ASUS Chromebook Flip - Image Customization](broken-reference)

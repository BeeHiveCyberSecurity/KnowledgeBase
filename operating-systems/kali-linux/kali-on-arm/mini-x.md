...
[Kali on Mini-X - Build-Script Instructions](broken-reference)
...
[Kali on Mini-X - User Instructions](broken-reference)
...
```
$ xzcat kali-linux-2022.4-mini-x-armhf.img.xz | sudo dd of=/dev/sdb bs=4M status=progres
```

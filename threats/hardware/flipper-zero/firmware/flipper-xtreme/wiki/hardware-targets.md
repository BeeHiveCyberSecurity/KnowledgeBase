...
You have to specify TARGET\_HW (and, optionally, FIRMWARE\_APP\_SET) for `fbt` to build firmware for non-default target. For example, building and flashing debug firmware for f18 can be done with
